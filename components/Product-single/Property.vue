...
<template>
    <div class="center gap-1 text-gray-500 text-[14.5px] font-medium">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-[15px] h-[16px] transform-[translateY(-0.5px)] fill-green" viewBox="0 0 24 24" width="512"
            height="512">
